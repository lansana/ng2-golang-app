...
func BuildBlock(size int) string {
	var r []rune
	for i := 0; i < size; i++ {
		r = append(r, rune(rand.Intn(25) + 65))
	}
	return string(r)
}

func RandomReferer() string {
	return referers[rand.Intn(referersCount)] + BuildBlock(rand.Intn(5) + 5)
}

func RandomKeepAlive() string {
	return strconv.Itoa(rand.Intn(10) + 100)
}


func RandomUserAgent() string {
	return agents[rand.Intn(agentsCount)]
}

var (
	referersCount int = len(referers)
